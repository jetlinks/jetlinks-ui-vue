<template>
    <a-modal open :title="dialogTitle" :maskClosable="false" width="675px" @ok="confirm"
        ...
        <a-form ref="formRef" :model="form.data" layout="vertical">
            <div class="formName" v-if="IsShow('add', 'edit')">{{ $t('components.EditUserDialog.939453-2') }}</div>
            <a-row :gutter="24" v-if="IsShow('add', 'edit')">
                <a-col :span="24">
                    <a-form-item name="name" :label="$t('components.EditUserDialog.939453-3')" :rules="[
            ...
            <a-row :gutter="24" v-if="IsShow('add', 'edit')">
                <a-col :span="12">
                    <a-form-item name="telephone" :label="$t('components.EditUserDialog.939453-6')" :rules="[
                        {
                            pattern: /^1[3456789]\d{9}$/,
                            message: $t('components.EditUserDialog.939453-7'),
                        },
                    ]">
                        <a-input v-model:value="form.data.telephone"
                            :placeholder="$t('components.EditUserDialog.939453-8')" :maxlength="64" />
                    </a-form-item>
                </a-col>
                <a-col :span="12">
                    <a-form-item name="email" :label="$t('components.EditUserDialog.939453-9')" :rules="[
                        {
                            pattern:
                                /^\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$/,
                        ...
                        <a-input v-model:value="form.data.email"
                            :placeholder="$t('components.EditUserDialog.939453-11')" :maxlength="64" />
                    </a-form-item>
                </a-col>
            </a-row>
            <a-row :gutter="24" v-if="IsShow('add', 'edit')">
            ...
            <div class="formName" v-if="IsShow('add', 'edit')">{{ $t('components.EditUserDialog.939453-16') }}
            </div>
            <a-row :gutter="24" v-if="IsShow('add', 'edit')">
                <a-col :span="24">
                    <a-form-item name="username" :label="$t('components.EditUserDialog.939453-17')"
                        :validateFirst="true" :rules="[
                        ...
                        <a-input v-model:value="form.data.username"
                            :placeholder="$t('components.EditUserDialog.939453-18')"
                            :disabled="props.type === 'edit'" />
                    </a-form-item>
                </a-col>
            </a-row>
            <a-row v-if="IsShow('add', 'reset')">
                <a-col :span="24">
                    <a-form-item name="password" :label="$t('components.EditUserDialog.939453-19')" :rules="[
                        ...
                        <a-input-password v-model:value="form.data.password"
            ...
            <a-row v-if="IsShow('add', 'reset')">
                <a-col :span="24">
                    <a-form-item name="confirmPassword" :label="$t('components.EditUserDialog.939453-21')" :rules="[
                        { required: true, message: '' },
                        {
                        ...
                        <a-input-password v-model:value="form.data.confirmPassword"
                            :placeholder="$t('components.EditUserDialog.939453-22')" :maxlength="64" />
                    </a-form-item>
                </a-col>
            </a-row>
        </a-form>
