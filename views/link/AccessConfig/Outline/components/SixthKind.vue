    ...
    <div>
        <a-descriptions bordered :column="1">
            <a-descriptions-item :label="i.label" v-for="i in configuration">
                {{ i.label === $t('components.SixthKind.707842-0')? i.value ?  $t('components.SixthKind.707842-1') : $t('components.SixthKind.707842-2') : i.value }}
            </a-descriptions-item>
        </a-descriptions>
    </div>
</template>
...
configurationMap.set('domain', $t('components.SixthKind.707842-3'));
configurationMap.set('sipId', 'SIP ID');
configurationMap.set('shareCluster', $t('components.SixthKind.707842-0'));
configurationMap.set('host', $t('components.SixthKind.707842-4'));
configurationMap.set('publicHost', $t('components.SixthKind.707842-5'));
