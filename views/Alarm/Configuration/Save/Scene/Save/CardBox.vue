    ...
    <div class="card-warp" :class="{ disabled: disabled }">
      ...
      <div class="card-content" :style="{ paddingTop: '40px' }">
        ...
        <div class="card-content-body">
          ...
          <div
            v-if="showMask && activeBranches.length && !isInvalid"
            v-show="!showBranchesVisible"
            class="card-mask"
            :class="{ 'branches-tabs-mask': showBranchesVisible }"
            :style="maskStyle"
          >
        ...
        <div
          class="card-content-tabs"
          v-if="showBranches && showBranchesVisible"
          @click.stop
        >
          <BranchesTabs
