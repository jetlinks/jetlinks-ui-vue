...
```typescript
import { DynamicRemoteLoader } from '@jetlinks-web/vite'
...
```typescript
import { loadRemoteComponent, preloadRemote } from '@jetlinks-web/vite'
...
import { loadRemoteComponent } from '@jetlinks-web/vite'
