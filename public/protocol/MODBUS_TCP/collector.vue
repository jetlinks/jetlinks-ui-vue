<template>
   <!-- <a-form-item :name="['configuration', 'host']" :rules="rules.host">
    ...
    <a-input placeholder="请输入Modbus主机IP" v-model:value="formData.configuration.host" />
  </a-form-item> -->
  ...
  <!-- <a-form-item label="端口" :name="['configuration', 'port']" :rules="rules.port">
    <a-input-number style="width: 100%" placeholder="请输入端口" v-model:value="formData.configuration.port" :min="0"
                    :max="65535" />
  </a-form-item> -->
