...
//查询模板详情
export const queryTemplateDetail = (data:any) => server.post('/resources/instance/detail/_query',data)

//查询模版详情不分页
export const queryTemplate = (data:any) => server.post('resources/instance/_query/no-paging',data)
