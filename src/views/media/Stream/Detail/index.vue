            ...
            <j-card>
                ...
                >
                    <j-row :gutter="[16, 0]">
                        ...
                        >
                            <j-col :span="!checked ? 12 : 8" class="form-item">
                                <j-form-item
                            ...
                            <j-col :span="12" class="form-item">
                                <j-form-item
                                    class="form-item"
                                    :name="['configuration', 'rtmpPort']"
                                    :rules="[
                                        {
                                            required: true,
                                            message: '请输入RTMP端口',
                                ...
                                >
                                    ...
                                    <j-input-number
                                        ...
                                        placeholder="RTMP 端口"
                                        v-model:value="
                                            formData.configuration.rtmpPort
                                        "
                                    />
                                </j-form-item>
                            </j-col>
                            <j-col :span="12" class="form-item">
                                ...
                                >
                                    ...
                                    <j-input-number
                                        ...
                                        placeholder="RTMP 端口"
                                        v-model:value="
                                            formData.configuration.rtspPort
                                        "
                                    />
                                </j-form-item>
                            </j-col>
