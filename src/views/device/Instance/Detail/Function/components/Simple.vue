    ...
    <div class="simple-wrapper">
        <div class="tips">
            <j-space>
                ...
                <span>{{ $t('components.Simple.155741-0') }}</span>
            </j-space>
        </div>
        <j-tabs
            v-model="activeKey"
                    ...
                    <j-col :span="15">
                                    ...
                                    >
                                        <j-form-item
                                            ...
                                            :rules="{
                                                ...
                                                message: $t('components.Simple.155741-2'),
                                            }"
                                            has-feedback
                                        >
                                            <ValueItem
                        ...
                        <div class="editor-btn">
                            <j-space>
                                ...
                                >
                                    {{ $t('components.Simple.155741-3') }}
                                </j-button>
                                <j-button
                                    type="default"
                                    @click="handleClear(func)"
                                >
                                    {{ $t('components.Simple.155741-4') }}
                                </j-button>
                            </j-space>
                        </div>
                    </j-col>
                    <j-col :span="9">
                        <h4>{{ $t('components.Simple.155741-5') }}</h4>
                        <span
...
const columns = ref([
    {
        title: $t('components.Simple.155741-6'),
        dataIndex: 'name',
        width: 150,
        ellipsis: true,
    },
    {
        title: $t('components.Simple.155741-7'),
        dataIndex: 'type',
        width: 150,
    },
    {
        title: $t('components.Simple.155741-8'),
        dataIndex: 'value',
    },
]);
...
const handleExecute = async (func: any) => {
    proxy?.$refs[`${func.id}Ref`][0]
        ...
        .then(async () => {
            ...
            if (!success) return;
            onlyMessage($t('components.Simple.155741-9'));
