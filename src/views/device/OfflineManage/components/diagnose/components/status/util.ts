...
TextColorMap.set('loading', '#262626');
TextColorMap.set('error', '#ff3325');
TextColorMap.set('success', '#00b87a');
TextColorMap.set('warning', '#ff9100');
