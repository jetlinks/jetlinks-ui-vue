...
/**
 * @function queryDataFn 请求数据的函数，useFilterAlarmDesc返回的函数
...
const rowSelection = {
    ...
    onSelect: (record: any, selected: boolean, selectedRows: any) => {
        // todo 当selectedRows.length === pageSize --> 等价于全选
        // todo 当selectedRows.length < pageSiz --> 等价于取消全选
    },
    onSelectAll: (selected: boolean, selectedRows: any, changeRows: any) => {
        isSelectAll.value = selectedRows?.length > 0;
    },
};
</script>
