                        ...
                        <a-row :gutter="[24, 0]">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <a-select
                                        v-model:value="formState.parserType"
                            ...
                            <a-col
                                :span="12"
                                v-if="
                                    isVisible('delimited', formState.parserType)
                                "
                            >
                                <a-form-item
                                    label="分隔符"
                            ...
                            <a-col
                                :span="24"
                                v-if="isVisible('lang', formState.parserType)"
                            >
                                <a-form-item
                                    v-show="false"
                                    label="脚本语言"
                            ...
                            <a-col
                                :span="24"
                                v-if="isVisible('script', formState.parserType)"
                            >
                                <a-form-item
                                    label="解析脚本"
                                    :name="[
                                ...
                                >
                                    <a-input
                                        ...
                                        "
                                        placeholder="请输入script"
                                    />
                                </a-form-item>
                            </a-col>
                            <a-col
                                :span="12"
                                v-if="isVisible('size', formState.parserType)"
                            >
                                <a-form-item
                                    label="长度值"
                                    :name="[
                            ...
                            <a-col
                                :span="12"
                                v-if="isVisible('length', formState.parserType)"
                            >
                                <a-form-item
                                    label="长度"
                                    :name="[
                                ...
                                >
                                    <a-input
                                        ...
                                        "
                                        placeholder="请输入length"
                                    />
                                </a-form-item>
                            </a-col>
                            <a-col
                                :span="12"
                                v-if="isVisible('offset', formState.parserType)"
                            >
                                <a-form-item
                                    label="偏移量"
                                    :name="[
                            ...
                            <a-col
                                :span="12"
                                v-if="isVisible('little', formState.parserType)"
                            >
                                <a-form-item
                                    label="大小端"
                                    :name="[
