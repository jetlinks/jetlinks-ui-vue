    ...
    // 物联网
    {
        ...
        children: [
            ...
            },
            {
                ...
                owner: 'iot',
                //parentId: '1',
                id: 'b6327c3ff01b49c9a7a96101606dc32a',
                url: '/iot/exchange',
                icon: 'icon-shebei',
                sortIndex: 5,
                permissions: [],
                ...
                children: [
                    {
                        code: 'exchange/receive',
                        name: '数据接收',
                        owner: 'iot',
                        id: '96e4bd287adbe0486e2168c59450122f',
                        sortIndex: 1,
                        url: '/iot/exchange/receive',
                        icon: 'icon-shezhi',
                        showPage: ['receive_sand'],
                        permissions: [],
                        buttons: [
                            {
                                id: 'view',
                    ...
                    },
                    {
                        ...
                        name: '数据发送',
                        owner: 'iot',
                        id: '96e4bd287adbe0486e2168c59450132f',
                        sortIndex: 2,
                        url: '/iot/exchange/send',
                        icon: 'icon-shezhi',
                        showPage: ['receive_sand'],
                        permissions: [],
                        buttons: [
    ...
    //物联卡
    {
        ...
        children: [
            ...
            },
            {
                ...
                permissions: [
                    { permission: 'network-flow', actions: ['query'] },
                ],
                accessSupport: { text: '间接支持', value: 'indirect' },
                supportDataAccess: false,
                indirectMenus: ['1deaa9efc0fc37a8e8e81fa9d6540bc3'],
